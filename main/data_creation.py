...
from VicsekWithNeighbourSelectionSwitchingCellBasedIndividualsDuration import VicsekWithNeighbourSelection
from EnumNeighbourSelectionMode import NeighbourSelectionMode
from EnumSwitchType import SwitchType
from ExternalStimulusOrientationChangeEventDuration import ExternalStimulusOrientationChangeEvent
                        ...
                        for startingCondition in ["ordered", "random"]:
                            ...
                            for i in range(iStart, iStop):
                                ...
                                simulator = VicsekWithNeighbourSelection(domainSize=domainSize,
                                                                        ...
                                                                        numberOfParticles=n,
                                                                        k=k,
                                                                        NeighbourSelectionMode=startValue,
                                                                        speed=speed,
                                                                        switchSummary=switchSummary,
                                                                        degreesOfVision=np.pi*2,
                                                                        events=[event])
