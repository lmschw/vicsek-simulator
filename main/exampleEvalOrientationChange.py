        ...
        for initialState in ["ordered"]:
            ...
            for density in [0.05, 0.07, 0.09]:
                ...
                for eventEffect in [EventEffect.TURN_BY_FIXED_ANGLE,
                        ...
                        savePath = f"single_{metric.value}_threshold-type-comp_eventEffect={eventEffect.val}_ind_avg_{initialState}_st=K_o=5_do=1_s={startValue}_d={density}_r={radius}_LOD_noise=1_th={threshold}_psteps={numberOfPreviousSteps}.svg"
