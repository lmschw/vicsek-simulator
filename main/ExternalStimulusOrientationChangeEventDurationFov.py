...
class ExternalStimulusOrientationChangeEventDurationFov(ExternalStimulusOrientationChangeEventDuration.ExternalStimulusOrientationChangeEventDuration):
    ...
    """
    def __init__(self, startTimestep, endTimestep, percentage, angle, eventEffect, movementPattern, movementSpeed, perceptionRadius=30, distributionType=DistributionType.GLOBAL, areas=None, orientation=[0,0], domainSize=dv.DEFAULT_DOMAIN_SIZE_2D, targetSwitchValue=None, degreesOfVision=360):
        """
