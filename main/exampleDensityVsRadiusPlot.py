...
for i in range(1, 4):
    ...
    for threshold in thresholdVals:
        ...
        savePath = f"radius-vs-density-maxorder-threshold={threshold}-i={i}.svg"
        ServiceImages.createDensityVsRadiusPlot(threshold=threshold, radiusVals=radiusVals, densityVals=densityVals, i=i, savePath=savePath)
        endTh = time.time()
