...
print("Data loading complete.")
evaluator = Evaluator.Evaluator(simulationData, modelParams, EnumMetrics.Metrics.CLUSTER_NUMBER_OVER_PARTICLE_LIFETIME)
evaluator.evaluateAndVisualize(savePath="LOD_n=200_k=5_noise=0_radius=10_CLUSTER_NUMBER_OVER_PARTICLE_LIFETIME.png")
