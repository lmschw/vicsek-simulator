...
modelParams, simulationData, colours, switchValues = ServiceSavedModel.loadModel("switch_individual_switchType=K_orderVal=5_disorderVal=1_tmax=5000_n=100_density=0.01_mode=NEAREST_noise=1%_orderthresholds=[0.95,0.5]_1.json", loadSwitchValues=True)
...
preparedAnimator.saveAnimation('switch_individual_switchType=K_orderVal=5_disorderVal=1_tmax=5000_n=100_noise=1%_orderthresholds=[0.95,0.5]_1.mp4')
